...
{
    public class PawnBoomNodulesDrawer : PawnOverlayDrawer
    {
        private const string BoomTexturePath = "Things/Pawn/Overlays/AI_BoomOverlay";

        public PawnBoomNodulesDrawer(Pawn pawn)
            : base(pawn)
        {
        }
        ...
        protected override void WriteCache(CacheKey key, PawnDrawParms parms, List<DrawCall> writeTarget)
        {
            ...
            if (graphic != null)
            {
                ...
                try
                {
                    ...
                    Material material = MaterialPool.MatFrom(BoomTexturePath, ShaderDatabase.Wound, Color.white);
